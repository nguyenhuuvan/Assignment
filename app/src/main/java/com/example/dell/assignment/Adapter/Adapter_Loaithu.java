...
public class Adapter_Loaithu extends BaseAdapter {
    ...
    public Adapter_Loaithu(List<Thu> thuList, Context context,OnItemDeleteListener deleteListener,OnItemEditListener editListener) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        String TenLoaiThu=thuList.get(position).getTenLoaithu();

        viewHolder.tvName.setText(TenLoaiThu);
        viewHolder.imgDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                deleteListener.onDelete(position,thuList.get(position).getIdloaithi());
            }
        });
        viewHolder.imgEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                editListener.onEdit(position,thuList.get(position).getIdloaithi());
            }
        });
        return view;
    }
