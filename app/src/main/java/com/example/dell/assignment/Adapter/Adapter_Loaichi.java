...
public class Adapter_Loaichi extends BaseAdapter {
    ...
    public Adapter_Loaichi(List<Chi> chiList, Context context, OnItemDeleteListener deleteListener, OnItemEditListener editListener) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        String TenLoaiChi = chiList.get(position).getTenLoaichi();

        viewHolder.tvName.setText(TenLoaiChi);
        viewHolder.imgDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                deleteListener.onDelete(position, chiList.get(position).getIdloaichi());
            }
        });
        viewHolder.imgEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                editListener.onEdit(position, chiList.get(position).getIdloaichi());
            }
        });
        return view;
    }
